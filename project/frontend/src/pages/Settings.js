...
const Settings = () => {
  ...
  return (
    <div className="page-container">
      ...
      {/* Night Mode */}
      <div className="glass" style={{ borderRadius: '15px', padding: '15px', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '15px' }}>
        <svg className="settings-icon" viewBox="0 0 20 20" fill="currentColor">
          <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
        </svg>
        <span className="settings-text" style={{ flex: 1 }}>Night Mode</span>
        <div 
          className={`toggle-switch ${nightMode ? 'active' : ''}`}
          onClick={() => setNightMode(!nightMode)}
        >
          <div className="toggle-thumb">
            <svg viewBox="0 0 12 12" fill="#1B0729" style={{ width: '12px', height: '12px' }}>
              <path d="M11.293 6.293A6 6 0 014.707 0.707a6.001 6.001 0 106.586 5.586z" />
            </svg>
          </div>
        </div>
      </div>
